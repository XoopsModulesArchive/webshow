<?php
// $Id: myheader.php,v 1.1 2004/01/29 14:45:56 buennagel Exp $
//  ------------------------------------------------------------------------ //
...
$mail_body = rawurlencode(sprintf(_WS_INTLINKFOUND,$xoopsConfig['sitename']).':  '.XOOPS_URL.'modules/'.$xoopsModule->getVar("dirname").'/singlelink.php?lid='.$lid.'&amp;cid='.$cid);
?>
...
<a target="main" href="ratelink.php?cid=<?php echo $cid; ?>&amp;lid=<?php echo $lid; ?>"><?php echo _WS_RATETHISSITE; ?></a> | <a target="main" href="modlink.php?lid=<?php echo $lid; ?>"><?php echo _WS_MODIFY; ?></a> | <a target="main" href="brokenlink.php?lid=<?php echo $lid; ?>"><?php echo _WS_REPORTBROKEN; ?></a> | <a target='_top' href='mailto:?subject=<?php echo $mail_subject; ?>&body=<?php echo $mail_body;?>'><?php echo _WS_TELLAFRIEND; ?></a> | <a target='_top' href="<?php echo XOOPS_URL; ?>">Back to <?php echo $xoopsConfig['sitename']; ?></a> | <a target='_top' href="<?php echo $url; ?>">Close Frame</a>
</small></td></tr></table>
